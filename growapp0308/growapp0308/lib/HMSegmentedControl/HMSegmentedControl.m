...
- (void)drawRect:(CGRect)rect {
    ...
    bottomBorder.frame = CGRectMake(0, self.frame.size.height-2, self.frame.size.width, 2);
    bottomBorder.backgroundColor = [UIColor colorWithRed:226.0f/255.0f green:226.0f/255.0f blue:226.0f/255.0f alpha:1].CGColor;
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionStyle == HMSegmentedControlSelectionStyleArrow) {
        ...
        if (self.selectionStyle == HMSegmentedControlSelectionStyleTextWidthStripe &&
            ...
            return CGRectMake(self.segmentWidth * self.selectedSegmentIndex+ self.selectionIndicatorEdgeInsets.left , indicatorYOffset, self.segmentWidth - self.selectionIndicatorEdgeInsets.right - self.selectionIndicatorEdgeInsets.left, self.selectionIndicatorHeight);
        }
    }
}
